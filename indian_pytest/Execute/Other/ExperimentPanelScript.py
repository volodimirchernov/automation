...
def add_users_into_experiment(chrome_driver, arr_user_id, project_name, status):
    open_page(chrome_driver, "https://dev5.pdffiller.com/33UMW1ZQ6goFeZ2o/?op=login")
...
def test_add_users(chrome_driver):
    add_users_into_experiment(chrome_driver, [user_id_Vova, user_id_Andrey, user_id_Sasha], project_name_Multi_Print, status_on)
